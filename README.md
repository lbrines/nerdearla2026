...
| Tema | Decisión |
| --- | --- |
| Datos de OpenCode | La única ruta persistente es `OPENCODE_DATA_DIR`; por defecto es `$HOME/.local/share/nerdearla2026/opencode` en el host y se monta en `/home/node/.local/share/opencode`. |
| Workspace | `/investigator-workspace` existe en la imagen, queda vacío y se descarta con el container. Phase 7 decidirá notas o protocolo. |
