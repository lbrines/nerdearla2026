...
| Acceso al lab | Solo `operator_net` y `/var/log/lab` read-only; no se montan el repositorio, `scenario`, Internal Operator ni el socket de Docker. Ambos perfiles tienen igual acceso a Internet normal e irrestricto. |
...
El repositorio público es el artefacto de reproducibilidad y se mantiene intencionalmente fuera del montaje de investigator; la paridad proviene del acceso igual a Internet y de las superficies locales idénticas.
